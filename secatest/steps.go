...
func verifyGlobalTenantResourceMetadataStep(ctx provider.StepCtx, expected *schema.GlobalTenantResourceMetadata, actual *schema.GlobalTenantResourceMetadata) {
...
func verifyRegionalResourceMetadataStep(ctx provider.StepCtx, expected *schema.RegionalResourceMetadata, actual *schema.RegionalResourceMetadata) {
	ctx.WithNewStep("Verify metadata", func(stepCtx provider.StepCtx) {
		stepCtx.Require().Equal(expected.Name, actual.Name, "Name should match expected")
		stepCtx.Require().Equal(expected.Provider, actual.Provider, "Provider should match expected")
		stepCtx.Require().Equal(expected.Resource, actual.Resource, "Resource should match expected")
...
func verifyRegionalWorkspaceResourceMetadataStep(ctx provider.StepCtx, expected *schema.RegionalWorkspaceResourceMetadata, actual *schema.RegionalWorkspaceResourceMetadata) {
	ctx.WithNewStep("Verify metadata", func(stepCtx provider.StepCtx) {
		stepCtx.Require().Equal(expected.Name, actual.Name, "Name should match expected")
		stepCtx.Require().Equal(expected.Provider, actual.Provider, "Provider should match expected")
		stepCtx.Require().Equal(expected.Resource, actual.Resource, "Resource should match expected")
...
func verifyRegionalNetworkResourceMetadataStep(ctx provider.StepCtx, expected *schema.RegionalNetworkResourceMetadata, actual *schema.RegionalNetworkResourceMetadata) {
	ctx.WithNewStep("Verify metadata", func(stepCtx provider.StepCtx) {
		stepCtx.Require().Equal(expected.Name, actual.Name, "Name should match expected")
		stepCtx.Require().Equal(expected.Provider, actual.Provider, "Provider should match expected")
		stepCtx.Require().Equal(expected.Resource, actual.Resource, "Resource should match expected")
...
func verifyStatusStep(ctx provider.StepCtx, expected schema.ResourceState, actual schema.ResourceState) {
...
func verifyLabelStep(ctx provider.StepCtx, expected schema.Labels, actual schema.Labels) {
...
func verifyRoleSpecStep(ctx provider.StepCtx, expected *schema.RoleSpec, actual *schema.RoleSpec) {
...
func verifyRoleAssignmentSpecStep(ctx provider.StepCtx, expected *schema.RoleAssignmentSpec, actual *schema.RoleAssignmentSpec) {
...
func verifyBlockStorageSpecStep(ctx provider.StepCtx, expected *schema.BlockStorageSpec, actual *schema.BlockStorageSpec) {
	ctx.WithNewStep("Verify BlockStorageSpec", func(stepCtx provider.StepCtx) {
		...
		skuRef, err := secalib.AsReferenceURN(actual.SkuRef)
		if err != nil {
			ctx.Error(err)
		}
...
func verifyImageSpecStep(ctx provider.StepCtx, expected *schema.ImageSpec, actual *schema.ImageSpec) {
	ctx.WithNewStep("Verify ImageSpec", func(stepCtx provider.StepCtx) {
		blockStorageRef, err := secalib.AsReferenceURN(actual.BlockStorageRef)
		if err != nil {
			ctx.Error(err)
		}
...
// TOOD Find a way to compare the objects values
func verifyInstanceSpecStep(ctx provider.StepCtx, expected *schema.InstanceSpec, actual *schema.InstanceSpec) {
	ctx.WithNewStep("Verify InstanceSpec", func(stepCtx provider.StepCtx) {
		...
		bootDeviceRef, err := secalib.AsReferenceURN(actual.BootVolume.DeviceRef)
		if err != nil {
			ctx.Error(err)
		}
		stepCtx.Require().Equal(expected.BootVolume.DeviceRef, bootDeviceRef, "BootVolume.DeviceRef should match expected")
	})
}

// Network Specs

func (suite *NetworkV1TestSuite) verifyNetworkSpecStep(ctx provider.StepCtx, expected *schema.NetworkSpec, actual *schema.NetworkSpec) {
	ctx.WithNewStep("Verify NetworkSpec", func(stepCtx provider.StepCtx) {
		...
		routeTableRef, err := secalib.AsReferenceURN(actual.RouteTableRef)
		if err != nil {
			ctx.Error(err)
		}
...
func (suite *NetworkV1TestSuite) verifyInternetGatewaySpecStep(ctx provider.StepCtx, expected *schema.InternetGatewaySpec, actual *schema.InternetGatewaySpec) {
...
func (suite *NetworkV1TestSuite) verifyRouteTableSpecStep(ctx provider.StepCtx, expected *schema.RouteTableSpec, actual *schema.RouteTableSpec) {
	ctx.WithNewStep("Verify RouteTableSpec", func(stepCtx provider.StepCtx) {
		...
		for i := 0; i < len(expected.Routes); i++ {
			...
			targetRef, err := secalib.AsReferenceURN(actualRoute.TargetRef)
			if err != nil {
				ctx.Error(err)
			}
...
func (suite *NetworkV1TestSuite) verifySubNetSpecStep(ctx provider.StepCtx, expected *schema.SubnetSpec, actual *schema.SubnetSpec) {
...
func (suite *NetworkV1TestSuite) verifyPublicIpSpecStep(ctx provider.StepCtx, expected *schema.PublicIpSpec, actual *schema.PublicIpSpec) {
...
func (suite *NetworkV1TestSuite) verifyNicSpecStep(ctx provider.StepCtx, expected *schema.NicSpec, actual *schema.NicSpec) {
	ctx.WithNewStep("Verify NicSpec", func(stepCtx provider.StepCtx) {
		...
		subnetRef, err := secalib.AsReferenceURN(actual.SubnetRef)
		if err != nil {
			ctx.Error(err)
		}
...
func (suite *NetworkV1TestSuite) verifySecurityGroupSpecStep(ctx provider.StepCtx, expected *schema.SecurityGroupSpec, actual *schema.SecurityGroupSpec) {
