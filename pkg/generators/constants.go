...
const (
	...
	securityGroupRuleListURL = urlProvidersPrefix + "%s/" + securityGroupRuleListResource
	...
	securityGroupRuleListResource = resourceWorkspacesPrefix + "/security-group-rules"
