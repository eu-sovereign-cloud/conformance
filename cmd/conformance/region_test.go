...
func TestRegionV1Suites(t *testing.T) {
	...
	providerQueriesSuite := region.CreateProviderQueriesV1TestSuite(globalTestSuite, config.Parameters.ClientRegion, config.Parameters.ScenariosAdditionalRegions)
