...
type resourceBuilder[B resourceBuilderType, S secapi.SpecType] struct {
	validator     *secalib.Validator
	parent        *B
	setName       func(string)
	setProvider   func(string)
...
type newResourceBuilderParams[B resourceBuilderType, S secapi.SpecType] struct {
	parent        *B
	setName       func(string)
	setProvider   func(string)
	setResource   func(string)
...
func newResourceBuilder[B resourceBuilderType, S secapi.SpecType](params newResourceBuilderParams[B, S]) *resourceBuilder[B, S] {
