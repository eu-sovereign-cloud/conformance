...
func ConfigureUpdateBlockStorageScenarioV1(scenario string, mockParams *mock.MockParams, suiteParams *params.UpdateBlockStorageV1Params) (*wiremock.Client, error) {
