...
func ConfigNetworkListLifecycleScenarioV1(scenario string, params *NetworkParamsV1) (*wiremock.Client, error) {
	...
	// Network
	networkList, err := createNetworkList(wm, scenario, params, "GetNetworkList")
	if err != nil {
		return nil, err
	}
	...
	// Internet gateway
	gatewayList, err := createInternetGatewayList(wm, scenario, params, "GetInternetGatewayList")
	if err != nil {
		return nil, err
	}
	...
	routeTableList, err := createRouteTableList(wm, scenario, params, "GetRouteTableList")
	if err != nil {
		return nil, err
	}
	// List
	...
	subnetList, err := createSubnetList(wm, scenario, params, "GetSubnetList")
	if err != nil {
		return nil, err
	}
	...
	publicIpList, err := createPublicIpList(wm, scenario, params, "GetPublicIpList")
	if err != nil {
		return nil, err
	}
	...
	// Nic
	nicList, err := createNicList(wm, scenario, params, "GetNICList")
	if err != nil {
		return nil, err
	}
	...
	// Security group
	securityGroupList, err := createSecurityGroupList(wm, scenario, params, "GetSecurityGroupList")
	if err != nil {
		return nil, err
	}
	...
	if err := deleteSecurityGroupList(wm, scenario, params, "DeletePublicIp_"+(*params.PublicIp)[0].Name); err != nil {
		return nil, err
	}
	// Delete NICs
	if err := deleteNics(wm, scenario, params, "DeletePublicIp_"+(*params.PublicIp)[0].Name); err != nil {
		return nil, err
	}
	// Delete Public IPs
	if err := deletePublicIpList(wm, scenario, params, "DeleteSubnet_"+(*params.Subnet)[0].Name); err != nil {
		return nil, err
	}

	// Delete Subnets
	if err := deleteSubnetList(wm, scenario, params, "DeleteRouteTable_"+(*params.RouteTable)[0].Name); err != nil {
		return nil, err
	}

	// Delete Route Tables
	if err := deleteRouteTableList(wm, scenario, params, "DeleteInternetGateway_"+(*params.InternetGateway)[0].Name); err != nil {
		return nil, err
	}

	// Delete Internet Gateways
	if err := deleteInternetGatewayList(wm, scenario, params, "DeleteNetwork_"+(*params.Network)[0].Name); err != nil {
		return nil, err
	}

	// Delete Networks
	if err := deleteNetworkList(wm, scenario, params, "DeleteWorkspace"); err != nil {
		return nil, err
	}
