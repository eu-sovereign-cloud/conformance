...
type UpdateBlockStorageV1TestSuite struct {
	suites.RegionalTestSuite

	StorageSkus []string

	params *params.UpdateBlockStorageV1Params
}

func NewUpdateBlockStorageV1TestSuite(regionalTestSuite suites.RegionalTestSuite, storageSkus []string) *UpdateBlockStorageV1TestSuite {
	suite := &UpdateBlockStorageV1TestSuite{
		RegionalTestSuite: regionalTestSuite,
		StorageSkus:       storageSkus,
	}
	suite.ScenarioName = constants.UpdateBlockStorageV1SuiteName.String()
	return suite
}
...
func (suite *UpdateBlockStorageV1TestSuite) BeforeAll(t provider.T) {
	...
	err = suites.SetupMockIfEnabled(suite.TestSuite, mockstorage.ConfigureUpdateBlockStorageScenarioV1, params)
	if err != nil {
		t.Fatalf("Failed to setup mock: %v", err)
	}
}

func (suite *UpdateBlockStorageV1TestSuite) TestScenario(t provider.T) {
...
func (suite *UpdateBlockStorageV1TestSuite) AfterAll(t provider.T) {
